<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Daily_Report.aspx.vb" Inherits="Daily_Report" %>
...
<table style="margin:auto;width:50%;margin-top:10%;text-align:left;border-collapse:collapse" >
    <tr>
        ...
        <asp:Label ID="TitleHeading" runat="server" Text="Daily Report"></asp:Label>                     
        </th>
    </tr>
    <tr>
        <td style="text-align:center">
        <asp:Label ID="TopCustomersHeading" runat="server" Text="Top Customers &#xD; of the Day"></asp:Label>                     
        </td>
        <td style="text-align:center">
        <asp:Label ID="TopProductsHeading" runat="server" Text="Top Selling Products &#xD; of the Day"></asp:Label>          
        </td>
        <td style="border:none;padding-left:2%">
        <asp:Label ID="DateFilterLabel" runat="server" Text="Date:"></asp:Label>
            <br />
        <ajaxToolkit:ComboBox ID="DateFilter" runat="server" AutoCompleteMode="SuggestAppend" AutoPostBack="True" DataSourceID="DateDataSource" DataTextField="Date_of_Order" DataValueField="Date_of_Order" DropDownStyle="DropDownList" MaxLength="0" style="display: inline" DataTextFormatString="{0:d}" Width="100px" BorderWidth="0px">
    ...
    <tr>
        ...
        <asp:AccessDataSource ID="FilteredOrdersDataSource" runat="server" DataFile="~/App_Data/Computer Science IA.mdb" DataSourceMode="DataReader" SelectCommand="SELECT * FROM [Orders] WHERE Date_of_Order = @date">
        <SelectParameters>
        <asp:ControlParameter ControlID="DateFilter" PropertyName="SelectedValue" Name="@date" />
        </SelectParameters>
        </asp:AccessDataSource>
        
        <asp:AccessDataSource ID="DateDataSource" runat="server" DataFile="~/App_Data/Computer Science IA.mdb" DataSourceMode="DataReader" SelectCommand="SELECT DISTINCT Date_of_Order FROM [Orders]">
        </asp:AccessDataSource>
