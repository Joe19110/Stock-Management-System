<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllTime_Report.aspx.vb" Inherits="AllTime_Report" %>
...
<table style="margin:auto;width:50%;margin-top:10%;text-align:left;border-collapse:collapse" >
    <tr>
        ...
        <asp:Label ID="TitleHeading" runat="server" Text="All Time Report"></asp:Label>                     
        </th>
    </tr>
    <tr>
        <td style="text-align:center">
        <asp:Label ID="TopCustomersHeading" runat="server" Text="Top Customers 
 of All Time"></asp:Label>                     
        </td>
        <td style="text-align:center">
 ...
 of All Time"></asp:Label>          
    ...
    <tr>
        ...
        <asp:AccessDataSource ID="FilteredOrdersDataSource" runat="server" DataFile="~/App_Data/Computer Science IA.mdb" DataSourceMode="DataReader" SelectCommand="SELECT * FROM [Orders]">
